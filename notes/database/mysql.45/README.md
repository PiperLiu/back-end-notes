...
- [深入理解事务隔离：`ReadView`](./drafts/mysql.45.01.003.md#深入理解事务隔离readview)
  - [什么是 `ReadView`？](./drafts/mysql.45.01.003.md#什么是-readview)
  - [`ReadView` 的 C++ 数据结构](./drafts/mysql.45.01.003.md#readview-的-c-数据结构)
  - [可见性检查算法（`changes_visible` 方法）](./drafts/mysql.45.01.003.md#可见性检查算法changes_visible-方法)
  - [`ReadView` 在四种隔离级别中的作用](./drafts/mysql.45.01.003.md#readview-在四种隔离级别中的作用)
- [实践实验：亲眼见证 `ReadView` 的作用](./drafts/mysql.45.01.003.md#实践实验亲眼见证-readview-的作用)
  - [步骤 1：设置](./drafts/mysql.45.01.003.md#步骤-1设置)
  - [场景 1：`REPEATABLE READ`（默认设置）](./drafts/mysql.45.01.003.md#场景-1repeatable-read默认设置)
  - [场景 2：`READ COMMITTED`](./drafts/mysql.45.01.003.md#场景-2read-committed)
- [深入解析 InnoDB：多版本数据如何与 B+ 树协同工作](./drafts/mysql.45.01.003.md#深入解析-innodb多版本数据如何与-b-树协同工作)
  - [Undo 日志与版本链](./drafts/mysql.45.01.003.md#undo-日志与版本链)
  - [B+ 树与多版本的协同工作](./drafts/mysql.45.01.003.md#b-树与多版本的协同工作)
  - [查询过程：索引查找与版本链遍历](./drafts/mysql.45.01.003.md#查询过程索引查找与版本链遍历)
  - [对索引和范围查找效率的影响](./drafts/mysql.45.01.003.md#对索引和范围查找效率的影响)
...
- [补充章节：深入代码：Server层锁的实现原理](./drafts/mysql.45.01.006.md#补充章节深入代码server层锁的实现原理)
  - [1. 全局锁 `FTWRL` 的实现](./drafts/mysql.45.01.006.md#1-全局锁-ftwrl-的实现)
  - [2. 表锁 `LOCK TABLES` 的实现](./drafts/mysql.45.01.006.md#2-表锁-lock-tables-的实现)
  - [3. 元数据锁 `MDL` 的实现](./drafts/mysql.45.01.006.md#3-元数据锁-mdl-的实现)
...
- [补充章节：深入代码：InnoDB行锁与死锁检测的实现细节](./drafts/mysql.45.01.007.md#补充章节深入代码innodb行锁与死锁检测的实现细节)
  - [1. InnoDB 行锁与两阶段锁的实现](./drafts/mysql.45.01.007.md#1-innodb-行锁与两阶段锁的实现)
  - [2. 主动死锁检测的实现](./drafts/mysql.45.01.007.md#2-主动死锁检测的实现)
  - [3. 死锁处理：受害者选择与回滚](./drafts/mysql.45.01.007.md#3-死锁处理受害者选择与回滚)
...
[./drafts/mysql.45.02.012.md](./drafts/mysql.45.02.012.md)

- [概述：语句序列是怎么加锁的，加的锁又是什么时候释放的](./drafts/mysql.45.02.012.md#概述语句序列是怎么加锁的加的锁又是什么时候释放的)
- [幻读是什么？](./drafts/mysql.45.02.012.md#幻读是什么)
- [幻读有什么问题？](./drafts/mysql.45.02.012.md#幻读有什么问题)
  - [语义上的问题](./drafts/mysql.45.02.012.md#语义上的问题)
  - [数据一致性的问题](./drafts/mysql.45.02.012.md#数据一致性的问题)
- [如何解决幻读？](./drafts/mysql.45.02.012.md#如何解决幻读)
  - [间隙锁 Gap Lock](./drafts/mysql.45.02.012.md#间隙锁-gap-lock)
  - [可重复读隔离级别下才有间隙锁](./drafts/mysql.45.02.012.md#可重复读隔离级别下才有间隙锁)

#### 21 | 为什么我只改一行的语句，锁这么多？

[./drafts/mysql.45.02.013.md](./drafts/mysql.45.02.013.md)

- [概述：加锁规则](./drafts/mysql.45.02.013.md#概述加锁规则)
- [案例一：等值查询间隙锁](./drafts/mysql.45.02.013.md#案例一等值查询间隙锁)
- [案例二：非唯一索引等值锁](./drafts/mysql.45.02.013.md#案例二非唯一索引等值锁)
- [案例三：主键索引范围锁](./drafts/mysql.45.02.013.md#案例三主键索引范围锁)
- [案例四：非唯一索引范围锁](./drafts/mysql.45.02.013.md#案例四非唯一索引范围锁)
- [案例五：唯一索引范围锁 bug](./drafts/mysql.45.02.013.md#案例五唯一索引范围锁-bug)
- [案例六：非唯一索引上存在"等值"的例子](./drafts/mysql.45.02.013.md#案例六非唯一索引上存在等值的例子)
- [案例七：limit 语句加锁](./drafts/mysql.45.02.013.md#案例七limit-语句加锁)
- [案例八：一个死锁的例子](./drafts/mysql.45.02.013.md#案例八一个死锁的例子)
- [小结与问题：似乎不相干的地方也被锁住了？](./drafts/mysql.45.02.013.md#小结与问题似乎不相干的地方也被锁住了)

#### 22 | MySQL有哪些“饮鸩止渴”提高性能的方法？

[./drafts/mysql.45.02.014.md](./drafts/mysql.45.02.014.md)

- [概述：临时提升性能的需求](./drafts/mysql.45.02.014.md#概述临时提升性能的需求)
- [短连接风暴](./drafts/mysql.45.02.014.md#短连接风暴)
  - [第一种方法：先处理掉那些占着连接但是不工作的线程](./drafts/mysql.45.02.014.md#第一种方法先处理掉那些占着连接但是不工作的线程)
  - [第二种方法：减少连接过程的消耗](./drafts/mysql.45.02.014.md#第二种方法减少连接过程的消耗)
- [慢查询性能问题](./drafts/mysql.45.02.014.md#慢查询性能问题)
  - [导致慢查询的第一种可能是，索引没有设计好](./drafts/mysql.45.02.014.md#导致慢查询的第一种可能是索引没有设计好)
  - [导致慢查询的第二种可能是，语句没写好](./drafts/mysql.45.02.014.md#导致慢查询的第二种可能是语句没写好)
  - [导致慢查询的第三种可能是，MySQL 选错了索引](./drafts/mysql.45.02.014.md#导致慢查询的第三种可能是mysql-选错了索引)
  - [预先避免问题：索引没设计好和语句没写好与pt-query-digest](./drafts/mysql.45.02.014.md#预先避免问题索引没设计好和语句没写好与pt-query-digest)
- [QPS 突增问题](./drafts/mysql.45.02.014.md#qps-突增问题)
